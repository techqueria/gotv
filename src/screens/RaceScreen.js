...
import RaceScroll from '../components/raceScroll/raceScroll'
    ...
    return (
      ...
      >
        <View style={styles.container}>
          ...
          >
            <Text style={styles.item}>Office</Text>
            <Text
              style={styles.text}
            >
...
export default connect(mapStateToProps, mapDispatchToProps)(RaceScreen);
